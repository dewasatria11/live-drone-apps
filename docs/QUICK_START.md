...
1. Hubungkan laptop dan HP remote DJI ke router/Wi‑Fi yang sama.
2. Buka aplikasi dan tunggu `Siap menerima video`.
3. Pilih `Tampilkan di HP`, lalu salin URL RTMP ke Custom RTMP di DJI Fly.
4. Mulai siaran DJI Fly dan tunggu status `Video masuk`.
