...
$versionOutput = choco list --local-only --exact innosetup --limit-output
if ($versionOutput -notcontains 'innosetup|6.7.1') { throw "Versi Inno Setup tidak sesuai pin 6.7.1: $versionOutput" }
